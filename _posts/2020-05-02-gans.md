...
| <img src='/assets/images/gans/onecluster.png'/> |
| :-----------------------------------------------: |
...
| <img src="/assets/images/gans/Run(run_id='202004071449', stop_epochs=1000, lr_d=0.01, lr_g=0.0001, decay=1e-06, momentum=0.9).png"/> | <img src="/assets/images/gans/Run(run_id='202004071436', stop_epochs=1000, lr_d=0.01, lr_g=0.0001, decay=1e-06, momentum=0.9).png"/> |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
...
|   <img src="../assets/images/gans/onecluster_tf.png"/>   |
| :------------------------------------------------------: |
...
https://github.com/qarchli/pytorch-gan-for-outlier-detection
